...
#     ('line', ''),
    ...
    ('Ours (sum pool)', 'superblue19/hyper-sum.json'),
    ('Ours (mean pool)', 'superblue19/hyper-mean.json'),
    ('Ours (w/o. raw feat)', 'superblue19/hyper-xraw.json'),
    ('LHNN-d16', 'superblue19/LHNN-d16.json'),
    ('LHNN-d32', 'superblue19/LHNN.json'),
    ('LHNN-d64', 'superblue19/LHNN-d64.json'),
    ('line', ''),
